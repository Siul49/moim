...
INSERT INTO "new_User" ("createdAt", "email", "eventSmsAgreed", "id", "isAgeOver14", "marketingAgreed", "nickname", "passwordHash", "phoneNumber", "privacyAgreedAt", "termsAgreedAt", "updatedAt") SELECT "createdAt", "email", "eventSmsAgreed", "id", "isAgeOver14", "marketingAgreed", "nickname", "passwordHash", "phoneNumber", "privacyAgreedAt", "termsAgreedAt", "updatedAt" FROM "User";
DROP TABLE "User";
